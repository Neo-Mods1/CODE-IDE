...
import com.neo.ide.templates.api.TemplateBuilder
import com.neo.ide.templates.api.TemplateRecipeConfigurator
import com.neo.ide.templates.api.TemplateRecipeFinalizer
import com.neo.ide.templates.api.base.models.Dependency
import com.neo.ide.templates.api.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
  ...
  open fun baseAsset(path: String) =
    com.neo.ide.templates.api.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.neo.ide.templates.api.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
