...
import com.neo.ide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
import com.neo.ide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.neo.ide.utils.ClassTrie, pkgName: String): Node? {
