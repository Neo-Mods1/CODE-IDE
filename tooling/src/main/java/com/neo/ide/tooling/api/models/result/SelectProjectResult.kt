...
package com.neo.ide.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][com.neo.ide.tooling.api.IProjectQueries].
 *
