...
import com.neo.ide.editor.R.layout
import com.neo.ide.editor.databinding.LayoutPopupMenuItemBinding
import com.neo.ide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.neo.ide.models.Range::class.java, editor.cursorLSPRange)
    data.put(
