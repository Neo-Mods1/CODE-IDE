...
import com.neo.ide.managers.ToolsManager
...
import com.neo.ide.templates.api.base.root.buildGradleSrcGroovy
import com.neo.ide.templates.api.base.root.buildGradleSrcKts
import com.neo.ide.templates.api.base.root.gradleWrapperProps
import com.neo.ide.templates.api.base.root.settingsGradleSrcStr
import com.neo.ide.templates.api.base.util.optonallyKts
...
class ProjectTemplateBuilder :
   ...
   * @see com.neo.ide.templates.api.base.baseAsset
   */
  fun baseAsset(path: String) =
    com.neo.ide.templates.api.base.util.baseAsset("root", path)
