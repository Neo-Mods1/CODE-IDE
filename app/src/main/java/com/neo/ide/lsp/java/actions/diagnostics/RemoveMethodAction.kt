...
import com.neo.ide.lsp.java.rewrite.RemoveMethod
import com.neo.ide.lsp.java.utils.CodeActionUtils.findMethod
...
class RemoveMethodAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (!visible || !data.hasRequiredData(
        com.neo.ide.lsp.models.DiagnosticItem::class.java)
    ) {
      markInvisible()
      return
    }
