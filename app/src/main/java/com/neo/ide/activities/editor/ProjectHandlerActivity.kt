...
import com.neo.ide.databinding.LayoutSearchProjectBinding
import com.neo.ide.flashbar.Flashbar
import com.neo.ide.fragments.sheets.ProgressSheet
import com.neo.ide.handlers.EditorBuildEventListener
import com.neo.ide.handlers.LspHandler.connectClient
import com.neo.ide.handlers.LspHandler.destroyLanguageServers
import com.neo.ide.lookup.Lookup
import com.neo.ide.lsp.IDELanguageClientImpl
...
import com.neo.ide.services.builder.GradleBuildServiceConnnection
import com.neo.ide.services.builder.gradleDistributionParams
import com.neo.ide.tasks.executeAsyncProvideError
import com.neo.ide.tasks.executeWithProgress
import com.neo.ide.tooling.api.messages.AndroidInitializationParams
...
import com.neo.ide.tooling.api.models.mapToSelectedVariants
import com.neo.ide.utils.DURATION_INDEFINITE
import com.neo.ide.utils.DialogUtils.newMaterialDialogBuilder
import com.neo.ide.utils.RecursiveFileSearcher
import com.neo.ide.utils.flashError
import com.neo.ide.utils.flashbarBuilder
import com.neo.ide.utils.resolveAttr
import com.neo.ide.utils.showOnUiThread
import com.neo.ide.utils.withIcon
  ...
  fun initializeProject(buildVariantsProvider: () -> Map<String, String>) {
    executeWithProgress { progress ->
      executeAsyncProvideError(buildVariantsProvider::invoke) { result, error ->
        com.neo.ide.tasks.runOnUiThread {
          progress.dismiss()
        }
