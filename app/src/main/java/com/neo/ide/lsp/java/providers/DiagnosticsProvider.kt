...
import com.neo.ide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.neo.ide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.neo.ide.lsp.java.visitors.DiagnosticVisitor
import com.neo.ide.lsp.models.DiagnosticItem
import com.neo.ide.lsp.models.DiagnosticSeverity
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.neo.ide.models.Position {
    abortIfCancelled()
    ...
    return com.neo.ide.models.Position(line, column)
  }
